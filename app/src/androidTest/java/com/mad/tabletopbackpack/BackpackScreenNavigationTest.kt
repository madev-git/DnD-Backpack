...
import com.mad.tabletopbackpack.ui.BackPackScreen
import com.mad.tabletopbackpack.ui.BackpackScreenEnum
import com.mad.tabletopbackpack.ui.BackpackUiState
import org.junit.Before
import org.junit.Rule
import org.junit.Test

class BackpackScreenNavigationTest {
    ...
    fun backpackNavHost_verifyStartDestination() {
        navController.assertCurrentRouteName(BackpackScreenEnum.Character.name)
    }
    ...
    fun backpackNavHost_bottomBarClickInventoryItem_navigateToInventoryScreen() {
        ...
        navController.assertCurrentRouteName(BackpackScreenEnum.Inventory.name)
    }
    ...
    fun backpackNavHost_bottomBarClickResourcesItem_navigateToResourcesScreen() {
        ...
        navController.assertCurrentRouteName(BackpackScreenEnum.Resources.name)
    }
    ...
    fun backpackNavHost_bottomBarClickStoryItem_navigateToStoryScreen() {
        ...
        navController.assertCurrentRouteName(BackpackScreenEnum.Story.name)
    }
